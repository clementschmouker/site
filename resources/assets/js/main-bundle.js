    ...
    _createClass(Parallax, [{
        ...
        value: function bindEvents() {
            ...
            window.addEventListener('scroll', function () {
                _this.prlx.map(function (item) {
                    _this.value = -((window.pageYOffset - item.offsetTop) * item.speed) / 10;
        ...
        value: function getDatas() {
            ...
            for (var i = 0; i < this.$els.parallaxedItems.length; i += 1) {
                this.prlx.push({
...
var _Flakes = require('./components/Flakes');

var _Flakes2 = _interopRequireDefault(_Flakes);
...
var flakes = new _Flakes2.default();
var parallax = new _Parallax2.default();
var home = new _Home2.default();

},{"./components/Flakes":2,"./components/Parallax":3,"./imports/CS_grid":4,"./pages/Home":6}],6:[function(require,module,exports){
'use strict';
...
var Home = function () {
    ...
    _createClass(Home, [{
        ...
        value: function initTitle() {
            ...
            for (var i = 0; i < this.$els.spans.length; i += 1) {
                this.$els.spans[i].classList.add('hide');
            }

            _gsap2.default.fromTo(this.$els.logo, 0.2, {
                y: "-50%",
                opacity: 0,
                ease: Power2.easeOut,
                force3D: true
        ...
        value: function animateTitle() {
            ...
            _gsap2.default.staggerFromTo(this.$els.spans, 0.5, {
                y: "100%",
                opacity: 0,
                force3D: true
            }, {
                ...
                _gsap2.default.to(_this2.$els.titleDecorator, 0.5, {
                    scaleX: 1
                });
            });
        }
        ...
        key: 'dropShuttle',
        value: function dropShuttle() {

            _gsap2.default.to(this.$els.shuttle, 2.4, {
        ...
        key: 'flickrShuttleLights',
        value: function flickrShuttleLights() {
